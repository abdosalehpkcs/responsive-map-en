...
class CsvReaderService {
  ...
  getCsvData() {
    ...
    return (0,C_Users_z004c7wn_Desktop_responsive_maps_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const csvUrl = `/responsive-map-en/assets/points_${_envs_env_prod__WEBPACK_IMPORTED_MODULE_5__.APP_CONFIG.language === 'en' ? "en" : _envs_env_prod__WEBPACK_IMPORTED_MODULE_5__.APP_CONFIG.language === 'da' ? "sk" : "uk"}.csv`;
      try {
